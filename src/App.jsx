  ...
  return (
    <div className="container">
      <header className="header">
        <img src={`${import.meta.env.BASE_URL}foto.jpg`} alt="Foto de perfil" className="profile-img" />
      ...
      <section className="projects">
        ...
        <div className="cards-container">
          <div className="card">
            <img src={`${import.meta.env.BASE_URL}itil.png`} alt="ITIL" className="card-icon" />
          ...
          <div className="card">
            <img src={`${import.meta.env.BASE_URL}oracle.png`} alt="Oracle RightNow" className="card-icon" />
          ...
          <div className="card">
            <img src={`${import.meta.env.BASE_URL}python.png`} alt="Python" className="card-icon" />
